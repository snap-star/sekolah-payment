...
export default function ReportIndex() {
    const { reports, summary } = usePage().props as {
        reports: ReportItem[];
        summary: {
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Rekapitulasi tagihan, pembayaran, dan kekurangan.
                    </p>
                </div>
                                ...
                                {(reports || []).map((r) => (
                                    <TableRow key={r.id}>
                                        ...
                                        <TableCell className="text-right font-bold text-destructive">
                                            {formatRupiah(r.kekurangan_bayar)}
                                        </TableCell>
                                        <TableCell>
                                            <Badge
                                                variant={
                                            ...
                                            {r.riwayat_pembayaran.length > 0 ? (
                                                ...
                                                >
                                                    <AccordionItem
                                                        ...
                                                        className="border-0"
                                                    >
                                                        <AccordionTrigger className="text-xs py-0 hover:no-underline">
                                                            {
                                                                r
                                                                    .riwayat_pembayaran
                                                                    .length
